...
'< Generated at / Generierung am                             2015-01-20, 22:56 >
' -----------------------------------------------------------------------------
...
TYPE GUI_MAINData
  ...
  AS GObject PTR _
  window1, aboutdialog_vbox1, aboutdialog_action_area1, actiongrMain, actLoad,  _
  actRun, actQuit, actInfo, menMain, srcview1, srcbuff
END TYPE
